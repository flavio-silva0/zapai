            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/12 border border-white/20 rounded-xl pl-11 pr-4 py-3.5 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-indigo-500/60 focus:bg-white/16 transition-all text-sm"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full bg-white/12 border border-white/20 rounded-xl pl-11 pr-12 py-3.5 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-indigo-500/60 focus:bg-white/16 transition-all text-sm"
                />
                <button
                  type="button"
